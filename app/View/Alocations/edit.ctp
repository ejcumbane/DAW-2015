...
<?php echo $this->Form->create('Alocation'); ?>
	<fieldset>
		<legend><?php echo __('Edit Alocation'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Alocation.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Alocation.id'))); ?></li>
